...
public class KafkaCruiseControlConfig extends AbstractConfig {
    ...
    private void sanityCheckSamplingPeriod(Map<?, ?> originals) {
        ...
        long reportingIntervalMs = getReportingIntervalMs(originals, brokerSampleWindowMs, samplingIntervalMs);
    ...
    private static long getReportingIntervalMs(Map<?, ?> originals, long brokerSampleWindowMs, long samplingIntervalMs) {
        ...
        return reporterConfig.getLong(CruiseControlMetricsReporterConfig.CRUISE_CONTROL_METRICS_REPORTER_INTERVAL_MS_CONFIG);
    }
