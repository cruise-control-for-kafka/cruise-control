...
public class ExecutionProposal {
    ...
    static boolean areAllReplicasInSync(PartitionInfo partitionInfo) {
        return new HashSet<>(Arrays.asList(partitionInfo.inSyncReplicas())).containsAll(Arrays.asList(partitionInfo.replicas()));
    }
    ...
    public boolean equals(Object other) {
        ...
        AtomicReference<ExecutionProposal> otherProposal = new AtomicReference<>((ExecutionProposal) other);

        return _tp.equals(otherProposal.get()._tp)
                && _oldLeader == otherProposal.get()._oldLeader
                && _oldReplicas.equals(otherProposal.get()._oldReplicas)
                && _newReplicas.equals(otherProposal.get()._newReplicas);
    }
