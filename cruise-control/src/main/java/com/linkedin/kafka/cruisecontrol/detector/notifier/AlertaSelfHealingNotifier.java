...
public class AlertaSelfHealingNotifier extends SelfHealingNotifier {
    ...
    private void alertTopicAnomaly(AnomalyType anomalyType, final String localHostname,
        ...
        if (topicAnomaly instanceof TopicPartitionSizeAnomaly topicPartitionSizeAnomaly) {
        ...
        } else if (topicAnomaly instanceof TopicReplicationFactorAnomaly topicReplicationFactorAnomaly) {
